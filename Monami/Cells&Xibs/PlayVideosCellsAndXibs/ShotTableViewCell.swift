...
class ShotTableViewCell: UITableViewCell, ASAutoPlayVideoLayerContainer {
    ...
    @IBOutlet weak var imageSponser: UIImageView!
    @IBOutlet weak var lblAddSubtitle: UILabel!
    ...
    func configureCell(imageUrl: String?,
                       description: String,
                       videoUrl: String?,sponserImageUrl: String,title: String,subtitle: String) {
        self.lblAdTitle.text = title
        self.lblAddSubtitle.text = subtitle
        self.imageSponser.sd_setImage(with: URL(string: sponserImageUrl), placeholderImage: UIImage(named: "user_signup"))
        self.descriptionLabel.text = description
        self.shotImageView.sd_setImage(with: URL(string: imageUrl!), placeholderImage: UIImage(named: "user_signup"))
