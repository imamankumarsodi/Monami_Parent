...
class CustomizedBundlee: Bundle {
    static var kAssociatedLanguageBundle = 0
    
    override func localizedString(forKey key: String, value: String?, table tableName: String?) -> String {
        
        let bundle: Bundle? = (objc_getAssociatedObject(self, &CustomizedBundlee.kAssociatedLanguageBundle) as! Bundle)
...
extension Bundle {
    class func setLanguage(_ language: String?) {
        var onceToken: Int = 0
        if (onceToken == 0) {
            object_setClass(Bundle.main, CustomizedBundlee.self)
        }
        onceToken = 1
        
        objc_setAssociatedObject(Bundle.main,&CustomizedBundlee.kAssociatedLanguageBundle, language != nil ? Bundle(path: Bundle.main.path(forResource: language, ofType: "lproj") ?? "") : nil, objc_AssociationPolicy.OBJC_ASSOCIATION_RETAIN_NONATOMIC)
    }
}
